...
if game:GetService("CoreGui"):FindFirstChild("phonghub") then
    game:GetService("CoreGui"):FindFirstChild("phonghub"):Destroy()
end
...
local Library = Update:Window("phong hub","",Enum.KeyCode.RightControl);
...
NguyenTien:AddLabel("NhÃ  SÃ¡ng Láº­p:  phong roblox")
...
setclipboard("https://youtube.com/@cặc")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
